...
# 	print(embed)
input_origin = '53e charmers st'
input_destination = '508e clark st'
...
#         return render_template("result.html",startingpoint=startingpoint,endingpoint = endingpoint, remaininggas = remaininggas, prefer = prefer, type1 = type1,embed = embed)
